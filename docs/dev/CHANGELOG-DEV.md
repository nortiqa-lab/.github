...
## 2026-08-02 — Governance storage seed + KNOW-001 + Lot A mirrors

### Added

- Notion DEV: `TAREA-NL-GOBERNANZA-ALMACENAMIENTO-001`  
  https://app.notion.com/p/3b0e4fe3bfea81c6acc2e485bdcf6558
- `exports/nortiqa-lab-governance/` — seed multi-entidad (estructura, README, APPLY, `apply.sh`, mirrors Lot A, inventarios A/B, pack script)
- `docs/migration/PLAN-NL-STORAGE-MIGRATION-001.md`
- `exports/sql/` — schema/seed agentes + `validate_local.py`
- Handoffs: `2026-08-02-governance-storage-seed.md`, `2026-08-02-storage-migration-fase0.md`

### Blocked

- `gh repo create nortiqa-lab/governance --private` → 403 `createRepository`
- Dictamen almacenamiento canónico no hallado (stub DEV en Notion + seed)
- Redirects Centro Doc Madre (requieren Gio + PAO/OT)

### Not changed

- VPS/prod, secretos, DNS, n8n; cuerpos Valent/LLA
