...
| DICT-NL-GOBERNANZA-ALMACENAMIENTO-001 | stub DEV Notion | Stub seed + Notion | dictamenes/ | Stub hecho — texto canónico Gio |
| DICT-NL-VISION-FUSION-001 | vía LOG | Ratificado 09-07; DICT no indexado | dictamenes/ | **Stub + LOG mirror hechos** |
| LOG-NL-SESION-20260709-001 | https://app.notion.com/p/398e4fe3bfea818d8a19f1c4c16bed92 | Log ratificaciones | logs/ | **Mirror seed hecho** |
| GOV-NL-ORG-001 | no indexada | Canon base | governance/ | **Stub localización** — pedir URL |
| REGLA-DEV-DICTAMEN-CLAUDE-001 | no encontrada | ? | governance/ | Bloqueado — confirmar a Gio |
| DICT-NL-LAPTOP-COMPRA-001 | no existe; hay PLAN-NL-HW-PORTATIL-001 (DEV) | DEV | — | No migrar |
| DICT-NL-AUDIT-GDRIVE-GIO-001 | no existe; hay PLAN-GIO-DRIVE-* (DEV) | DEV | — | No migrar |
...
| Lot A gaps (VISION/LOG/GOV stub) | Hecho — Fase 0.3 |
| Lot B inventario | Hecho — ver `INV-NL-MIGRATION-CANDIDATES-LOTE-B.md` |
| Lot C cierre gaps | Hecho — ver `INV-NL-MIGRATION-CANDIDATES-LOTE-C.md` |
| SQL schema+seed | Hecho; validate via `exports/sql/validate_local.py` |
| Pack / apply.sh | Hechos |
